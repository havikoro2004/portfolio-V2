        ...
        <div className="relative right-2 md:absolute py-3">
          <ul className="flex gap-4 md:flex-row items-center justify-center p-4 md:p-0">
            <li>
              <Link
                target="_blank"
                to="https://www.linkedin.com/in/najib-flata"
              >
                <FontAwesomeIcon
                  icon={faGithub}
                  className="text-2xl transition-all duration-300 ease-in-out hover:text-3xl"
                />
              </Link>
            </li>
            <li>
              <Link target="_blank" to="https://github.com/havikoro2004">
                <FontAwesomeIcon
                  icon={faLinkedinIn}
                  className="text-2xl transition-all duration-300 ease-in-out hover:text-3xl"
                />
