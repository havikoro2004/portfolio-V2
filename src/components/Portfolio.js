        ...
        <div className="w-full md:h-[550px] h-[400x] md:px-2 md-5 flex flex-col items-center justify-center text-center text-white md:mb-0 mb-10">
          ...
          {showParagraph && ( // Condition pour afficher le paragraphe lorsque showParagraph est true
            <motion.div
              ...
              transition={{ duration: 0.5 }} // Durée de l'animation
            >
              <h1 className="text-4xl text-croissant underline text-center py-3">
                Compétences
              </h1>
              <div className="px-3">
                <div className="flex items-center justify-center gap-3">
                  ...
                  <div className="w-[16.6%] flex justify-center">
                    <FontAwesomeIcon
                      className="text-6xl svg"
                      icon={faBootstrap}
                    />
                  </div>
                  <div className="w-[16.6%] flex justify-center">
                    <img
                      className="w-24 text-white svg"
                      src={tailwind}
                      alt=""
                    />
                  </div>
            ...
            <div className="">
              <div className=" ">
                <div className="flex justify-center items-end mb-2">
                  <div
                    className={`transition-all ease-out duration-300 flex flex-none w-full gap-2 ${
                      carousPage === 1
                        ? "translate-x-[50%]"
                        : "translate-x-[-50%]"
                    }`}
                      ...
                      <div className="flex-col opacity-0 hover:opacity-90 transition-all ease-out duration-300 absolute top- bg-gradient-to-r from-sky-500 to-indigo-500 w-full text-white h-full flex items-center justify-center rounded">
                        <div className="md:mb-5 p-3 md:p-0 flex justify-center flex-wrap gap-3">
                          <div className="flex gap-3">
                            ...
                            <Link
                              target="_blank"
                              to="https://github.com/havikoro2004/studi-eva1"
                            >
                              {" "}
                              <FontAwesomeIcon
                                icon={faGithub}
                      ...
                      <div className="flex-col opacity-0 hover:opacity-90 transition-all ease-out duration-300 absolute top- bg-gradient-to-r from-sky-500 to-indigo-500 w-full text-white h-full flex items-center justify-center rounded">
                        <div className="md:mb-5 p-3 md:p-0 flex justify-center flex-wrap gap-3">
                          <div className="flex gap-3">
                            ...
                            <Link
                              target="_blank"
                              to="https://github.com/havikoro2004/studi-eva4"
                            >
                              {" "}
                              <FontAwesomeIcon
                                icon={faGithub}
                      ...
                      <div className="flex-col opacity-0 hover:opacity-90 transition-all ease-out duration-300 absolute top- bg-gradient-to-r from-sky-500 to-indigo-500 w-full text-white h-full flex items-center justify-center rounded">
                        <div className="md:mb-5 p-3 md:p-0 flex justify-center flex-wrap gap-3">
                          <div className="flex gap-3">
                            ...
                            <Link
                              target="_blank"
                              to="https://github.com/havikoro2004/studi-eva2"
                            >
                              {" "}
                              <FontAwesomeIcon
                                icon={faGithub}
